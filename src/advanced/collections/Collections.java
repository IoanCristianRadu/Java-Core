...
class QueueExample {
    ...
    private static void methodsWithExceptions() {
        System.out.println("Queue with basic.methods that throw basic.exceptions");
    ...
    private static void methodsWithoutExceptions() {
        System.out.println("\nQueue with basic.methods that return false/null");
        Queue<Integer> queue = new PriorityQueue<>();
        queue.clear();
        queue.offer(5);
        queue.offer(4);
...
class DequeExample {
    ...
    private static void methodsWithExceptions() {
        System.out.println("Deque with basic.methods that throw basic.exceptions");
    ...
    private static void methodsWithoutExceptions() {
        System.out.println("\nDeque with basic.methods that return false/null");
        Deque<Integer> deque = new ArrayDeque<>();
        deque.offer(5);
        deque.offerFirst(8);
        deque.offerLast(2);
