...
public class PrimitiveDataTypes {
    public static void main(String[] args) {
        ...
        // Default value 0
        // USE: Integer is generally used as the default basic.data type for integral values
        ...
        // Float basic.data type is never used for precise values such as currency
        float f = 0.5f;

        // double = 64 bit floating point
        // Default value 0.0d
        // USE: As the default basic.data type for decimal values generally the default choice
        // Double basic.data type should never be used for precise values such as currency
