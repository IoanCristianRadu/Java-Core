...
public class Volatile {
    // The volatile modifier is used to let the JVM know that a thread accessing the basic.variable
    // must always merge its own private copy of the basic.variable with the master copy in the memory.
}
